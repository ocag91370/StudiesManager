...
namespace MaxicoursDownloader.Api.Controllers
{
    ...
    public class ExportController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("schoollevels/{levelTag}/subjects/{subjectId:int}/themes/{themeId:int}/videolessons")]
        public IActionResult ExportThemeVideoLessons(string levelTag, int subjectId, int themeId)
        {
            try
            {
                var exportResult = _exportService.ExportVideoLessons(levelTag, subjectId, themeId);
