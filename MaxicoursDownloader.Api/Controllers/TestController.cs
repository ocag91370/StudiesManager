    ...
    public class TestController : ControllerBase
    {
        ...
        public IActionResult Get()
        {
            var urls = new List<string>() {
                ...
                "https://entraide-covid19.maxicours.com/LSI/prod/Quizz/?act=init&nid=5088&from=arbo&meta_mat=mat&_vp=%2Fhome%2Fbo%2F5006%2F5088&_eid=fcafrfk6crdp0qmdnk3jllja16"
            };

            var result = urls.Select(o => new { Url = o, Result = o.GetReferenceFromUrl() }).ToList();
